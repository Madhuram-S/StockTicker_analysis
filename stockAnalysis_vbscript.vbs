' Main function that will filter the data and do the analysis
    ...
    For Each aws In ThisWorkbook.Worksheets
        ...
        For i = 2 To UBound(source_data, 1) ' ignore row 1 as it is header row
            ...
            If (source_data(i, 1) <> next_tkr) Then
                ...
                If (min_max(3, 3) <> 0 And min_max(3, 3) > percent_chng) Then
                ...
                ElseIf (min_max(3, 3) = 0) Then
                    min_max(3, 3) = percent_chng
                    min_max(3, 2) = source_data(i, 1)
                End If
                
                If (min_max(2, 3) <> 0 And min_max(2, 3) < percent_chng) Then
            ...
            Else
                If (set_open_val) Then
                    open_val = source_data(i, 3)    ' capture the stock open value in a variable
